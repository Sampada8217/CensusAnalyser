...
public class CensusAnalyserTest {
    ...
    public void givenIndianCensusData_whenCSVFileTypeIncorrect_shouldThrowException() {
        try {
            ...
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_TYPE_INCORRECT_PATH,INDIA_STATE_CSV_FILE_PATH);
        } catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM, e.type);
        }
    }
    ...
    public void givenIndianCensusCSV_whenHeaderIncorrect_shouldThrowException() {
        try {
            ...
            ExpectedException exception = ExpectedException.none();
            exception.expect(CensusAnalyserException.class);
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_INCORRECT_HEADER_PATH,INDIA_STATE_INCORRECT_HEADER_PATH);
        } catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM, e.type);
        }
    }
